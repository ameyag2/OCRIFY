...
def main():
    ...
    with col1:
        st.title("OCR App")      # Title and subtitle
        st.subheader("Extract text from input")
    ...
    st.markdown("""
        <div class="footer">
            <p>Powered by OCR App © 2024<br>Created by Ameya Gidh<br>Connect with me on 
            <a href="https://www.linkedin.com/in/ameyasg" target="_blank">LinkedIn</a></p>
        </div>
    """, unsafe_allow_html=True)
